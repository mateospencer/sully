...
pygame.display.set_caption('Speed Limit Race Master')
...
def airIMG(x,y):
    air = pygame.image.load("bg_air.png")
    run = True
    while run:
        screen.blit(air,(x,y))
...
def groundIMG(x,y):
    ground = pygame.image.load("bg_ground.png")
    run = True
    while run:
    ...
    while run:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
def ground(x,y):
    airtext = IntroFont.render("ground",True,(255,0,0))
    screen.blit (airtext,(x,y))
def air(x,y):
    groundText = IntroFont.render("air",True,(255,0,0))
    screen.blit(groundText,(x,y))
def about(x,y):
...
def introscreen():
    ...
    while run :
        ...
        button2 = pygame.Rect(265,440,175,50)
        button3 = pygame.Rect(600,440,175,50)
        ...
        #### if our cursor is on button1 which is ground button
        ...
        #### if we click on the ground button ####
            if click:
                countdown() ## CALLING COUNTDOWN FUNCTION TO START OUR GAME


        #### if our cursor is on button2 which is air button
        if button2.collidepoint(x,y):
        ### changing from inactive to active by changing the color from white to red 
            pygame.draw.rect(screen, (155,0,0), button2,6)
        #### if we click on the air button ####
            if click:
                countdown2()### DISPLAYING OUR air IMAGE BY CALLING IT
...
def countdown2():
    ...
    countdownBacground = pygame.image.load('bg_air.png')
    ...
    pygame.display.update()
    time.sleep(1)
    gameloop2() #calling the gameloop so that our game can start after the countdown
    pygame.display.update()


#defining our ground gameloop function
def gameloop():
    ...
    bg_ground = pygame.image.load('bg_ground.png')
...
def gameloop2():
    ...
    #setting background image
    bg_air = pygame.image.load('bg_air.png')
    
    
    # setting our player
    mainplane = pygame.image.load('plane.png')
    mainplaneX = 350
    mainplaneY = 495
    mainplaneX_change = 0
    mainplaneY_change = 0
    ...
    plane1X = random.randint(178,490)
    plane1Y = 100
    plane1Ychange = 3 
    plane2 = pygame.image.load('plane2.png')
    plane2X = random.randint(178,490)
    plane2Y = 100
    plane2Ychange = 3

    plane3 = pygame.image.load('plane3.png')
    plane3X = random.randint(178,490)
    plane3Y = 100
    plane3Ychange = 3
    ...
    while run:
        ...
        #setting boundary for our main plane
        if mainplaneX < 178:
            mainplaneX = 178
        if mainplaneX > 490:
            mainplaneX = 490
        ...
        #displaying the background image
        screen.blit(bg_air,(0,0))

        #displaying our main plane
        screen.blit(mainplane,(mainplaneX,mainplaneY))

        #displaing other planes
        screen.blit(plane1,(plane1X,plane1Y))
        screen.blit(plane2,(plane2X,plane2Y))
        screen.blit(plane3,(plane3X,plane3Y))
          #calling our show_score function
        show_score(570,280)
        #calling show_hiscore function
        show_highscore(0,0)
        ...
        #updating the values
        mainplaneX += mainplaneX_change
        mainplaneY += mainplaneY_change

        #movement of the enemies
        plane1Y += plane1Ychange
        plane2Y += plane2Ychange
        plane3Y += plane3Ychange
        #moving enemies infinitely
        if plane1Y > 670:
            plane1Y = -100
            plane1X = random.randint(178,490)
        ...
        #DETECTING COLLISIONS BETWEEN THE PLANES

        #getting distance between our main plane and plane1
        def iscollision(plane1X,plane1Y,mainplaneX,mainplaneY):
            distance = math.sqrt(math.pow(plane1X-mainplaneX,2) + math.pow(plane1Y - mainplaneY,2)) 
        ...
        #getting distance between our main plane and plane2
        def iscollision(plane2X,plane2Y,mainplaneX,mainplaneY):
            distance = math.sqrt(math.pow(plane2X-mainplaneX,2) + math.pow(plane2Y - mainplaneY,2))
        ...
        #getting distance between our main plane and plane3
        def iscollision(plane3X,plane3Y,mainplaneX,mainplaneY):
            distance = math.sqrt(math.pow(plane3X-mainplaneX,2) + math.pow(plane3Y - mainplaneY,2))
        ...
        #collision between mainplane and plane1
        coll1 = iscollision(plane1X,plane1Y,mainplaneX,mainplaneY) 

        #collision between mainplane and plane2
        coll2 = iscollision(plane2X,plane2Y,mainplaneX,mainplaneY) 

        #collision between mainplane and plane3
        coll3 = iscollision(plane3X,plane3Y,mainplaneX,mainplaneY) 
        ...
        if plane1Ychange == 0 and plane2Ychange == 0 and plane3Ychange == 0 :
          pass
...
def countdown():
    font2 = pygame.font.Font('freesansbold.ttf', 85)
    countdownBacground = pygame.image.load('bg_ground.png')
    three = font2.render('3',True, (187,30,16))
    two =   font2.render('2',True, (255,255,0))
    one =   font2.render('1',True, (51,165,50))
    go =    font2.render('GO!!!',True, (0,255,0))
